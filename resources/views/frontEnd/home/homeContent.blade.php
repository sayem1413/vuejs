            ...
            <div class="col-md-4 new-gd-middle">
                <div class="new-levis">
                    ...
                    <div class="mid-text">
                        ...
                        <a class="hvr-outline-out button2" href="{{url('/mens-category')}}">Shop now </a>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="new-levis">
                    <div class="mid-text">
                        ...
                        <a class="hvr-outline-out button2" href="{{url('/womens-category')}}">Shop now </a>
                    </div>
                    <div class="mid-img">
                        ...
                        <div class="col-md-3 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset('public/productImage/'.$publishedProduct->productImage)}}" alt="image" class="pro-image-front">
                                    <img src="{{asset('public/productImage/'.$publishedProduct->productImage)}}" alt="image" class="pro-image-back">
