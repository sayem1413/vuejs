        ...
        <div class="col-md-4 products-left">
            ...
            <div class="css-treeview">
                ...
                <ul class="tree-list-pad">
                    <li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0">
                            <span></span>Men's Wear</label>
                        <ul>
                            <li><input type="checkbox" id="item-0-0" /><label for="item-0-0">Ethinic Wear</label>
                                <ul>
                                    <li><a href="{{url('/mens-category')}}">Shirts</a></li>
                                    <li><a href="{{url('/mens-category')}}">Caps</a></li>
                                    <li><a href="{{url('/mens-category')}}">Shoes</a></li>
                                    <li><a href="{{url('/mens-category')}}">Pants</a></li>
                                    <li><a href="{{url('/mens-category')}}">SunGlasses</a></li>
                                    <li><a href="{{url('/mens-category')}}">Trousers</a></li>
                                </ul>
                            </li>
