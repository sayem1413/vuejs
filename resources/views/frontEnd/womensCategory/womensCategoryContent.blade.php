                    ...
                    <li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><span></span>Women's Wear</label>
                        <ul>
                            <li><input type="checkbox" id="item-0-0" /><label for="item-0-0">Ethinic Wear</label>
                                <ul>
                                    <li><a href="{{url('/womens-category')}}">Sarees</a></li>
                                    <li><a href="{{url('/womens-category')}}">Chudidars</a></li>
                                    <li><a href="{{url('/womens-category')}}">Wedges</a></li>
                                    <li><a href="{{url('/womens-category')}}">Tops</a></li>
                                    <li><a href="{{url('/womens-category')}}">Perfumes</a></li>
                                    <li><a href="{{url('/womens-category')}}">Caps</a></li>
                                </ul>
                            </li>
